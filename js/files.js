const files = {
  ...
  'welcome': {
    'content': [
      ...
      ['                           \x1b[3mVS Code\x1b[0m, \x1b[3mHyper\x1b[0m and \x1b[3mTheia\x1b[0m!', ['VS Code', 'https://github.com/microsoft/vscode'], ['Hyper', 'https://github.com/vercel/hyper'], ['Theia', 'https://github.com/eclipse-theia/theia']],
      [''],
      [' ┌ \x1b[1mFeatures\x1b[0m ──────────────────────────────────────────────────────────────────┐'],
      [' │                                                                            │'],
      [' │  \x1b[31;1mApps just work                         \x1b[32mPerformance\x1b[0m                        │'],
      [' │   Xterm.js works with most terminal      Xterm.js is fast and includes an  │'],
      [' │   apps like bash, vim and tmux           optional \x1b[3mWebGL renderer\x1b[0m           │', ['WebGL renderer', 'https://npmjs.com/package/xterm-addon-webgl']],
      [' │                                                                            │'],
